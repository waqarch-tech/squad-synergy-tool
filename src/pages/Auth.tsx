...
const Auth = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const validatedEmail = emailSchema.parse(signUpData.email);
      const validatedPassword = passwordSchema.parse(signUpData.password);
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      const validatedEmail = emailSchema.parse(signInData.email);
      const validatedPassword = passwordSchema.parse(signInData.password);
